            ...
            <div class="modal-content rounded-3 border-0 shadow">
                ...
                <form
                    ...
                    <div class="modal-footer d-flex justify-content-end">
                        <button type="button" class="btn-cancle  btn-sm" data-bs-dismiss="modal">Cancel</button>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1 flex-wrap">
                                <form action="{{ route('gym.staff.destroy', $s->id) }}" method="POST"
                                    ...
                                    @csrf
                                    <button class="btn btn-action btn-cancle small"
                ...
                <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between gap-1 mt-2">
                        <form action="{{ route('gym.staff.destroy', $s->id) }}" method="POST"
                            ...
                            @csrf
                            <button type="submit" class="btn btn-action btn-cancle">
