...
<style>
    ...
    border: none;
    min-width: 80px; /* Forces buttons to be the same width */
}

/* Specific Edit Button Styling */
.btn-action.btn-primary {
    background: linear-gradient(45deg, #cdff00 0%, #a2c900 100%);
    color: #000 !important;
    box-shadow: 0 2px 5px rgba(205, 255, 0, 0.2);
}
...
.btn-edit {
    ...
    .btn-edit:hover {
        background: linear-gradient(45deg, #b8d600 0%, #6b8f02 100%);
        color: #000;
    ...
    .name-head th{
        background: linear-gradient( #1a1a1a 0%, #2d2d2d 100%);
    ...
    .glow-textarea:focus {
        border-color: #cdff00;
        box-shadow: 0 0 0 0.35rem rgba(205, 255, 0, 0.25);
        outline: none;
    }
...
<div class="container-fluid mt-3">
                    ...
                    <tr style="background:#f8fafc; border-radius:6px;">
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1 flex-wrap">
                                <a href="{{ route('membership.edit', $m->id) }}" class="btn btn-action btn-sm btn-edit">
                                ...
                                <form method="POST" action="{{ url('/membership/delete/' . $m->id) }}"
                                    ...
                                    @csrf
                                    <button type="submit" class="btn btn-action btn-sm btn-delete"
    ...
    <div class="d-md-none" id="mobileMembershipsAccordion">
        ...
        <div class="card mb-3 member-card shadow-sm" data-member-id="{{ $m->id }}">
            <dname-head th d-flex justify-content-between align-items-center p-2" data-bs-toggle="collapse"
                ...
                <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between gap-1 mt-2">
                        ...
                        <form method="POST" action="{{ url('/membership/delete/' . $m->id) }}"
                            style="display:inline-block;">
                            @csrf
                            <button type="submit" class="btn btn-cancle btn-action btn-sm"
                                onclick="return confirm('Delete this membership?')">
                                <i class="bi bi-trash me-1"></i> Delete
                            </button>
                        </form>
                    ...
                    <div class="modal-body" style="max-height:70vh; overflow-y:auto;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" rows="4" class="form-control glow-textarea"></textarea>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group" id="categoriesList">
                        ...
                        <li class="list-group-item" data-id="{{ $c->id }}">
                            <span>{{ $c->name }}</span>
                            <button class="btn btn-cancle remove-category">Delete</button>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group" id="installmentsList">
                        ...
                        <li class="list-group-item" data-id="{{ $ins->id }}">
                            ...
                            <button class="btn btn-cancle remove-install">Delete</button>
                        </li>
                        @endforeach
                    </ul>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const cards = document.querySelename-head th[data-bs-toggle="collapse"]');
            cards.forEach(card => {
        ...
        document.getElementById('addCategoryBtn').addEventListener('click', function() {
            ...
            fetch("{{ route('membership.category.add') }}", {
                ...
                .then(obj => {
                    ...
                    li.innerHTML =
                        `${obj.name} <button class="btn btn-sm btn-cancle remove-category">Delete</button>`;
                    ul.prepend(li);
        ...
        document.getElementById('addInstallBtn').addEventListener('click', function() {
            ...
            fetch("{{ route('membership.installment.add') }}", {
                ...
                .then(obj => {
                    ...
                    li.dataset.id = obj.id;
                    li.innerHTML =
                        `${obj.title} - $${parseFloat(obj.amount).toFixed(2)} <button class="btn btn-sm btn-cancle remove-install">Delete</button>`;
                    ul.prepend(li);
