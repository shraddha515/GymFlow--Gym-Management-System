...
<style>
    ...
    .form-control:focus {
        border-color: #ADCD25;
        box-shadow: 0 0 0 0.2rem rgba(47, 49, 52, 0.25);
    }
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header  text-white"
                    style="background: linear-gradient(45deg, #cdff00 0%, #799402 100%);">
                ...
                <div class="card-body">
                    <button class="btn  text-white mb-3" data-bs-toggle="modal" data-bs-target="#addSuperAdminModal"
                        style="background: linear-gradient(45deg, #cdff00 0%, #799402 100%);">Add New Super
                        Admin</button>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('gym.settings.update') }}" method="POST">
                        ...
                        <button type="submit" class="btn text-black w-83"
                            style="background: linear-gradient(45deg, #cdff00 0%, #799402  100%);">Update Profile</button>
                    </form>
