...
<head>
    ...
    <style>
        ...
        .btn-primary {
            ...
            font-size: 1.1rem;
            transition: all 0.3s ease;
            box-shadow: 0 5px 15px #799402;
        }

        .btn-primary:hover {
            border-color: #799402;
            transform: translateY(-3px);
            box-shadow: 0 8px 20px rgba(40, 76, 41, 0.8);
        }
...
<body>
    ...
    <div class="login-card">
        <img src="{{ asset('asset/login-logo.png') }}" alt="Gym-Suvidha Logo" class="login-logo">
